...
const services = [
  ...
  {
    icon: Sparkles,
    title: "Formule Sièges et Plafond",
    description: "Aspiration complète de l'habitacle, Shampouinage des sièges, moquettes et tapis, Désinfection vapeur, Traitement des odeurs, Nettoyage des plastiques, Nettoyage des vitres",
    features: ["Durée : 2h"],
    price: "95€",
  },
  {
    icon: Truck,
    title: "Formule Luxury Intérieur Complet Extérieur",
    description: "Tout le contenu de la formule intérieur, Aspiration complète de l'habitacle, Désinfection vapeur, Traitement des odeurs, Nettoyage des plastiques, Nettoyage complet de l'extérieur au détail, Contre des portes",
    features: ["Durée : 3h"],
    price: "120€",
  },
  {
    icon: Shield,
    title: "Formule Premium Luxury",
    description: "Tout le contenu de la formule intérieur + extérieur, Démontage des sièges et banquettes, Nettoyage approfondi des zones difficiles d'accès",
    features: ["Durée : 5h"],
    price: "170€",
  },
  {
